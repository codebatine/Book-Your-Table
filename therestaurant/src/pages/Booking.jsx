...
import { loadReadContract, loadWriteContract, requestAccount, walletChecker } from '../services/blockchainService';
...
export const Booking = () => {
  ...
  const [booking, setBooking] = useState({id: 0, numberOfGuests: 0, name: "", date: "", time: "", resturantId: 0});
  ...
  <div className="booking-wrapper">
    ...
    <Bookingform booking={booking} handleBooking={handleBooking} createBooking={createBooking}/>
